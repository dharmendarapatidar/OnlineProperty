...
from .models import Login, CreatePlotModel,AppartmentModel,EmployeeModel,SalesModel
...
def storeSales(request):
    ...
    advance=request.POST.get("adv00000ance")
...
def logOut(request):
    ...
    return render(request, "signin1.html", {"msg": "Sucessfully Logout"})
